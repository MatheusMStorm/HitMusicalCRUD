 ...
 * @author moura
 */
public class InserirMicrofone extends javax.swing.JFrame {

    /**
     * Creates new form Inserirmicrofone
     */
    public InserirMicrofone() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Formato (opcional):");

        jLabel5.setText("Tipo (opcional):");

        jLabel6.setText("Frequência mínima (opcional):");

        jLabel7.setText("Padrão polar (opcional):");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        microfone.setDescricao(jTextField1.getText());
        microfone.setMarca(jTextField2.getText());
        microfone.setValor(Double.parseDouble(jTextField3.getText()));
        microfone.setFormato(jTextField4.getText());
        microfone.setTipo(jTextField5.getText());
        microfone.setFrequenciaMin(jTextField6.getText());
        microfone.setPadraoPolar(jTextField7.getText());
