 ...
 * @author moura
 */
public class InserirInstrumento extends javax.swing.JFrame {

    /**
     * Creates new form Inseririnstrumento
     */
    public InserirInstrumento() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        instrumento.setDescricao(jTextField1.getText());
        instrumento.setMarca(jTextField2.getText());
        instrumento.setValor(Double.parseDouble(jTextField3.getText()));
        instrumento.setCategoria(jTextField4.getText());
