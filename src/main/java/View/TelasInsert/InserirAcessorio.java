 ...
 * @author moura
 */
public class InserirAcessorio extends javax.swing.JFrame {

    /**
     * Creates new form InserirAcessorio
     */
    public InserirAcessorio() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        acessorio.setDescricao(jTextField1.getText());
        acessorio.setMarca(jTextField2.getText());
        acessorio.setValor(Double.parseDouble(jTextField3.getText()));
        acessorio.setCategoria(jTextField4.getText());
