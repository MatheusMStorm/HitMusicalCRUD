 ...
 * @author moura
 */
public class AtualizarMicrofone extends javax.swing.JFrame {

    /**
     * Creates new form Atualizarmicrofone
     */
    public AtualizarMicrofone() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Formato (opcional)");

        jLabel6.setText("Tipo (opcional):");

        jLabel7.setText("Frequência mínima (opcional):");
        ...
        jLabel8.setText("Padrão polar (opcional):");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        microfone.setId(Integer.parseInt(jTextField1.getText()));
        
        if (microfone.getId() != 0) {
            microfone.setDescricao(jTextField2.getText());
            microfone.setMarca(jTextField3.getText());
            microfone.setValor(Double.parseDouble(jTextField4.getText()));
            microfone.setFormato(jTextField5.getText());
            microfone.setTipo(jTextField6.getText());
            microfone.setFrequenciaMin(jTextField7.getText());
            microfone.setPadraoPolar(jTextField8.getText());
        }
