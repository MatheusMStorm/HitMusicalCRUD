 ...
 * @author moura
 */
public class AtualizarCaixaSom extends javax.swing.JFrame {

    /**
     * Creates new form AtualizarCaixaSom
     */
    public AtualizarCaixaSom() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Potência de saída (opcional)");

        jLabel6.setText("Tipo de alto-falante");

        jLabel7.setText("Quantidade de alto-falantes (opcional):");
        ...
        jLabel8.setText("Configuração de canais (opcional):");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        caixaSom.setId(Integer.parseInt(jTextField1.getText()));
        
        if (caixaSom.getId() != 0) {
            caixaSom.setDescricao(jTextField2.getText());
            caixaSom.setMarca(jTextField3.getText());
            caixaSom.setValor(Double.parseDouble(jTextField4.getText()));
            caixaSom.setPotenciaSaida(Integer.parseInt(jTextField5.getText()));
            caixaSom.setTipoAltoFalante(jTextField6.getText());
            caixaSom.setQtdAltoFalantes(Integer.parseInt(jTextField7.getText()));
            caixaSom.setConfigCanais(jTextField8.getText());
        }
