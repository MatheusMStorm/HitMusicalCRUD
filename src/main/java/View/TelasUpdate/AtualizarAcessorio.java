 ...
 * @author moura
 */
public class AtualizarAcessorio extends javax.swing.JFrame {

    /**
     * Creates new form AtualizarAcessorio
     */
    public AtualizarAcessorio() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        acessorio.setId(Integer.parseInt(jTextField1.getText()));
                            
        if (acessorio.getId() != 0) {
            acessorio.setDescricao(jTextField2.getText());
            acessorio.setMarca(jTextField3.getText());
            acessorio.setValor(Double.parseDouble(jTextField4.getText()));
            acessorio.setCategoria(jTextField5.getText());
            }
